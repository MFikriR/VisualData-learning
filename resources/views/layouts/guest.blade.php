...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div class="absolute top-4 right-4 z-50">
            <button onclick="toggleTheme()" class="p-2 rounded-lg bg-white dark:bg-gray-800 text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 shadow-sm border border-gray-200 dark:border-gray-700 transition-all focus:outline-none">
